...
nvcc -D_DEBUG -lgomp -arch=compute_20 --compiler-options "-fno-strict-aliasing -Wall -fopenmp" -O3 -o lenser_gpu lensDriver.cpp lensFuncs.cpp help.cpp cudaLens.cu
